...
{
    public partial class GetTopics : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            var responseTask = httpClient.GetAsync("http://webstrar7.fulton.asu.edu/page4/Service1.svc/GetTopics/" + topic);
